...
Route::group(['middleware' => 'VerifyAppInstalled'], function () {
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => 'admin'], function () {
            ...
            Route::get('/broadcasts-ajax/data', 'BroadcastController@indexData');
			...
			// @AppCloudData coupons 
			// http://dturismo.site/admin/coupons
			// http://dturismo.site/admin/coupons/create
             Route::resource('/coupons', 'CouponController');
			 Route::get('/coupons-index/data', 'CouponController@indexData');
