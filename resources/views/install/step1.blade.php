            ...
            <div id="install-form">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h5>Proneilrabbit SMM Panel Installation Wizard</h5>
                    </div>
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal"
                            ...
                            <div class="form-group{{ $errors->has('envato_username') ? ' has-error' : '' }}">
                                <label for="envato_username" class="col-sm-2 control-label">Envato Username Nulled by interDeha</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="envato_username" name="envato_username" value="{{ old('envato_username') }}"  placeholder="Write something">
                                </div>
                            </div>
                            <div class="form-group{{ $errors->has('envato_purchase_code') ? ' has-error' : '' }}">
                                <label for="envato_purchase_code" class="col-sm-2 control-label">Envato Purchase Code Nulled by interDeha</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="envato_purchase_code" name="envato_purchase_code" value="{{ old('envato_purchase_code') }}"  placeholder="Write something">
                                </div>
                            </div>
