...
<head>
    ...
    @if(getOption('panel_theme') == 'material')
        ...
        <link href="/css/Proneilrabbit.css?v={{ config('constants.VERSION') }}" rel="stylesheet">
        <style>
            body {
    ...
    @elseif(getOption('panel_theme') == 'simple')
        ...
        <link href="/css/Proneilrabbit-theme-simple.css?v={{ config('constants.VERSION') }}" rel="stylesheet">
    @elseif(getOption('panel_theme') == 'fancy')
        <link href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700,400italic" rel="stylesheet">
        <link href="/css/Proneilrabbit-theme-fancy.css?v={{ config('constants.VERSION') }}" rel="stylesheet">
     @endif
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ url('/') }}">
                <img src="{{ asset(getOption('logo')) }}" alt="Retina"  height="50">
            </a>
        </div>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
							...
							<li>
                                <a href="{{ url('/admin/coupons') }}">@lang('menus.coupons')</a>
                            </li>
                        </ul>
                    </li>
