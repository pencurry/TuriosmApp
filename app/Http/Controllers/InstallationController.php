...
{
    const LICENSE_SERVER_URL = 'https://vs.Proneil.com';
    ...
    public function storeStep1(Request $request)
    {
        ...
        try {
            ...
            setOption('app_key', 'nulledby add us on whatsapp +1 484 303 8407');
            setOption('app_code', 'nulledby panelable.com');
    ...
    public function processTransfer(Request $request)
    {
        ...
        try {
            ...
            setOption('app_key', 'nulledbyinterdeha');
            setOption('app_code', 'nulledbyinterdeha');
